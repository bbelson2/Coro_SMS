\documentclass[format=manuscript, review=false, screen=true]{acmart}
...
% Note - for arXiv, the abstract is restrit=cted to 1920 characters. This version (as published) contains 1947 (incl spaces).
...
\iffalse
% This version was used for the arXiv metadata.
\begin{abstract}
...
% Suppress the repeated "Manuscript submitted to ACM" on 1st page (only)
% From https://tex.stackexchange.com/a/166991
\thispagestyle{empty}

% If the default list of authors is too long for headers.
%\renewcommand{\shortauthors}{B. Belson et al.}

\input{Coroutines-SMS-41}

\input{Coroutines-SMS-Supp-41}
